...
export default async function LocationsPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-500/10 dark:bg-blue-600/5 blur-[100px] rounded-full -z-10" />
      ...
      <div className="max-w-6xl mx-auto p-6 md:p-12 space-y-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px]  uppercase tracking-[0.3em] text-gray-700 dark:text-zinc-500">
                Geofencing Active
              </span>
            </div>
            <h1 className="text-4xl md:text-6xl  text-foreground tracking-tighter leading-none">
          ...
          <div className="flex bg-card dark:bg-zinc-900/40 backdrop-blur-xl border border-gray-200 dark:border-white/5 p-5 md:p-6 rounded-sm items-center gap-6 shadow-xl shadow-black/5">
            <div className="text-right">
              <p className="text-[10px]  uppercase tracking-widest text-gray-700 dark:text-zinc-500">Active Zones</p>
        ...
        <div className="space-y-6">
           <div className="flex items-center gap-3 px-4">
              ...
              <h2 className="text-[11px]  uppercase tracking-[0.2em] text-gray-700 dark:text-zinc-600">
                Live Zone Directory
              </h2>
           </div>
              ...
              <table className="w-full text-left border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-gray-50 dark:bg-white/[0.02] border-b border-gray-200 dark:border-white/5">
                    <th className="p-8 text-[11px]  text-gray-700 dark:text-zinc-400 uppercase tracking-widest">City Name</th>
                    <th className="p-8 text-[11px]  text-gray-700 dark:text-zinc-400 uppercase tracking-widest">Zip Code</th>
                    <th className="p-8 text-[11px]  text-gray-700 dark:text-zinc-400 uppercase tracking-widest text-center">Serving Status</th>
                    <th className="p-8 text-[11px]  text-gray-700 dark:text-zinc-400 uppercase tracking-widest text-right">Actions</th>
                  </tr>
                </thead>
                      ...
                      <td colSpan={4} className="p-24 text-center">
                        <div className="flex flex-col items-center gap-6">
                          ...
                          <div className="space-y-1">
                            <p className="text-foreground  text-xl tracking-tight">No active zones found</p>
